...
We are listing the different roles and the page number of where each is first introduced. ***do we need these bullet points or should we just take it out since we have the table?***
...
employment2 <- employment |>
  select(Month, Year, Job, Page.Number, Monthly.Total.Workers)

# removed notes column when displaying table

kable(employment2, caption = "Parsons Employment by Job Type from January-June of 1861 ") |>
...
## How do Parsons wages compare to the state averages?

The table is adapted from page 314 of *Most Wonderful Machine: Mechanization and Social Change in Berkshire Paper Making, 1801-1885*, which used data from page 74 of the *Tenth Annual Report of the Bureau of Statistics of Labor* (Boston, 1879)
...
kable(weekly_wages, caption = "Weekly Wages of Massachusetts Paper Workmen, 1860-78") |>
  kable_styling(font_size = 8)
