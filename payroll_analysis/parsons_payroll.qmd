...
-   Some pages have a separate section of employees at the bottom under "Repairs" and "Reparis & Watchmen" (April 1862 p.45 - 4 employees under 'Repairs & Watchmen') \-- I included these names in the counts above
...
## Spreadsheet tracking employment by job type for first 6 months and last 6 months of the register

```{r}
library(googlesheets4)
employment <- read_sheet("https://docs.google.com/spreadsheets/d/1dza87xBB2pgVajOuLYBM_fHfAobr6IFIZFAu4vFOnhs/edit#gid=0")
