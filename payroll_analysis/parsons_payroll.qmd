...
```{r}
#| label: fig3
#| fig.cap: "Distribution of total wages for 44 employees at Parsons Paper Company in February 1867"
#| fig-subcap: Data from Table 1 from p.253 of the register. Literacy is measured by an employee's ability to sign their own name in the payroll."
#| echo: false
#| message: false
...
@tbl-wages and Figure 7 are adapted from page 314 of Judith McGaw's *Most Wonderful Machine: Mechanization and Social Change in Berkshire Paper Making, 1801-1885*, which used data from page 74 of the *Tenth Annual Report of the Bureau of Statistics of Labor* (Boston, 1879).
