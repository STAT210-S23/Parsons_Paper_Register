...
Table 3 displays the different roles recorded for the first six months of the register, from January to June of 1861. The role labels on the register become very sporadic and difficult to track after 1861, however, 'Repairs' and 'Repairs and Watchmen' remain in their own section at the bottom of the register pages throughout all of the pay periods. There were 5 people under "Repairs" for April 1st, 1867 (see Figure 6 in 'Appendix') and 8 people under April 1st, 1868 (see Figure 7 in 'Appendix').
...
ggplot(data=parsons_weekly_wages, aes(x = reorder(Job, weekly_wages), y = weekly_wages, fill = Job)) +
  geom_bar(stat="identity", position = "dodge") +
   labs(x = "Job", y = "Weekly Wage ($)", title = "Weekly Wages of Parsons Paper Company Workers - 1861") + theme(axis.text.x = element_text(size = 6))
=======
...
>>>>>>> 59b25e49ac41d8667b8ce63360c65bf5891ae2cd
```
