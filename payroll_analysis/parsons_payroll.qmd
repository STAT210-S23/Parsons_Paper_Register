...
kable(register_clean, caption = "Table 1. Portion of Register Page 253") |>
...
kable(employees, caption = "Table 2. Number of Parsons Paper Company Employees by Year", col.names = c("Year", "Number of Employees", "Subset Page Numbers")) |>
  kable_styling(font_size = 8) |>
  row_spec(0,bold=TRUE)
```

The average number of workers employed at Parsons Paper Company across the measured 9 years spanning the register is **136 employees between 1861-1869**. From Table 2 above, we can see that the number of employees generally increased over the years, with a noticeable boom in employment towards the end of the Civil War in 1865. In Chapter IV of *Holyoke, Massachusetts"*, Green mentions that these paper mills had abnormally high employee retention rates compared to other industries. From *Burt's Illustrated Guide of the Connecticut Valley* ([page 79](https://quod.lib.umich.edu/m/moa/AAB2140.0001.001/83)), we also know that at the end of 1867, Parsons employed 150 people and had "nineteen engines for grinding rags, "turning out "800 tons of paper yearly."
