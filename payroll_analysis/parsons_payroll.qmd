...
In the illustrative analysis below, we used a transcribed copy of page 253 (Figure 1) of the register to compare the number of employees who were able to sign their own signatures to the number of employees who were not able to on a singular page, and examine whether there was a relationship between literacy and pay. Table 1 displays the transcript of page 253.
...
```{r}
#| label: fig3
#| fig.cap: "Distribution of total wages for 44 employees at Parsons Paper Company in February 1867. Data is taken from Table 1 from p.253 of the register. Literacy is measured by an employee's ability to sign their own name in the payroll."
#| echo: false
#| message: false
