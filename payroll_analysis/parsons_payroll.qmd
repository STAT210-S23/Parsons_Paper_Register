...
This agreed upon reduce in output is important because it may indicate that at the start of the register, employee wages were lower than they would have been under normal circumstance. Any subsequent change in payment patterns is important, as it can indicate both local and domestic economic shocks and sector-specific economic factors.
...
These quotes about repairs are important because, as evidenced in the following section, repairmen who worked during the same week could receive different weekly wages. Perhaps those who replaced machinery that was less integral to daily business operations received a lower overtime pay than those who worked on the Fourdrinier. Additionally, repairmen were most likely compensated more for their work on Sunday than on weekdays.
...
These graphs show how the Parsons Paper Company wages in 1861 were lower than the average wages of Massachusetts paper workmen in 1860 for the lowly roles, such as the rag room and cutters, and significantly higher wages for the more the higher paying jobs of machine room, fireman, engineer, and finisher. The only job in which Parsons Paper Company underpaid relative to the state average is the foreman position. It may be beneficial to compare the Parsons Paper Company wages to those of other paper mills in Holyoke, as opposed to the entire state, to get a better understanding of how the Parsons Paper Company paid relative to its direct competitors.
