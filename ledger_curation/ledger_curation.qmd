...
```{r}
#| label: fig2
#| fig.cap: "\\label{fig:fig2} page 286 of register after color correcting. On the left is a large rectangle cut off, a little bigger than the width of the stamps, suggesting they were cut off."
#| out.width: "75%"
#| echo: false
