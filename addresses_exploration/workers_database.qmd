...
One way our class has begun this journey is by analyzing an old payroll registry found in an attic in Holyoke and now available in the archives of the Holyoke Public Library History Room.
This register tracked pay for employees who worked at the Parsons Paper Mill in Holyoke, Massachusetts (the "Paper City") in the 1860s.
...
In the registry, we can see one's name, number of days worked, their wages, whether or not the worker had rent or board due, the final balance owed, and signature (see @fig-sample).
See [https://r.amherst.edu/apps/nhorton/Parsons-Paper/](https://r.amherst.edu/apps/nhorton/Parsons-Paper/) for an interactive display of the register.

```{r, out.height="47%"}
#| label: fig-sample
#| echo: false
#| fig.cap: "Page XX of the Registry"
knitr::include_graphics("Registry_page_header.jpeg")
```

## Workers' Summary

We took on the task of finding information about some of the employees at the paper mill.
We used the database ancestry.com.
